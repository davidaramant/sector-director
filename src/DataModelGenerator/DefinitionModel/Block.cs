...
public sealed class Block
{
	...
	public IEnumerable<IProperty> OrderedProperties() =>
		Properties.Where(p => p.IsRequired).Concat(Properties.Where(p => !p.IsRequired));

	public Block(string formatName, IEnumerable<IProperty> properties, string codeName = null, bool isSubBlock = true)
	{
