...
public sealed class Camera2DTests
{
	...
	{
		var camera = new Camera2D { ScreenBounds = new Point(ScreenWidth, ScreenHeight) };
	...
	{
		var camera = new Camera2D { Center = new Vector2(10, 10), ScreenBounds = new Point(ScreenWidth, ScreenHeight) };
