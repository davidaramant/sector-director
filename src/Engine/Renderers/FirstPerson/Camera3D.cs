...
public sealed class Camera3D
{
	...
	public Vector3 PerspectiveToWorld(Vector3 screenCoordinate) =>
		Vector3.Transform(screenCoordinate, PerspectiveToWorldTransformation);

	public Vector3 WorldToPerspective(Vector3 worldCoordinate) =>
		Vector3.Transform(worldCoordinate, WorldToPerspectiveTransformation);
	...
	private void UpdateMatricesIfStale()
	{
		if (_matrixStale)
		{
			...
			_worldToPerspectiveTransformation = centerTranslationMatrix * rotationMatrix;
