...
public sealed class Camera2D
{
	...
	public Vector2 ScreenToWorld(Vector2 screenCoordinate) =>
		Vector2.Transform(screenCoordinate, ScreenToWorldTransformation);

	public Vector2 WorldToScreen(Vector2 worldCoordinate) =>
		Vector2.Transform(worldCoordinate, WorldToScreenTransformation);
