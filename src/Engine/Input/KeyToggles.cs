...
{
	readonly KeyboardLatch _toggleFullscreenLatch = new KeyboardLatch(kb =>
	...
	readonly List<(KeyboardLatch latch, DiscreteInput input)> _simpleToggles =
		new List<(KeyboardLatch latch, DiscreteInput input)>();
